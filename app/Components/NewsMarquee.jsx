...
const NewsMarquee = () => {
  ...
  const newsItems = [
    "প্রসিকিউটদের দুর্নীতি বরদাস্ত করা হবে না: প্রধান কৌঁসুলি ",
    "‘যুদ্ধ ও শান্তি’ নিয়ে কথা বললেন ট্রাম্প, পুতিন ",
   "প্রতিশ্রুতি থেকে সরব না, যুদ্ধের জেরে কিছুটা সময় লাগবে: প্রধানমন্ত্রী",
    "কবর থেকে তোলা কঙ্কাল ৭ হাজারে কিনে ২০ হাজারে বিক্রি"
  ];
