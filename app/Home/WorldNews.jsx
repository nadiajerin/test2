...
const WorldNews = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto p-4 font-sans bg-white">
            ...
            <p className=" max-sm:text-md text-xl font-bold text-red-500 underline text-center mb-6">
                বিশ্ব
            </p>

            {/* --- Top Main News Section --- */}
            {data.slice(0, 1).map((news) => (
                <Link href={`/world/${news.id}`} key={news.id} className="group cursor-pointer">
            ...
            {/* Adds Image */}
            {/* <img
                src="https://i.ibb.co.com/j9LRRGnj/adds3.jpg"
                alt="Main News"
                className="w-full h-auto object-cover my-10 hidden lg:block"
            /> */}
            {/* Mobile Views Adds Image */}
            {/* <img
                src="https://i.ibb.co.com/fYJjGKnp/adds4.jpg"
                alt="Main News"
                className="w-full h-auto object-cover my-10 lg:hidden"
            /> */}
